...
{
    public sealed class KhufuV11SegmentTag : MonoBehaviour
    {
        ...
        public void Configure(IEnumerable<string> ids, string evidenceClass, bool hasFactualShape, bool usesGameplayScale)
        {
