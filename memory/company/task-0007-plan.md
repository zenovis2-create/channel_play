...
Task ID: task-0007
Status: planned
Suggested agent: unity_gameplay
Suggested reviewer: none
Required evidence: Unity compile, playtest, and refreshed capture evidence

## Request

피드백 수정 작업 수행: Reframe `Operator_Overview_Camera` to show the playable School MVP route, player start, and primary objective landmarks in one legible overview. Keep the capture deterministic and retain the non-blank PNG validation. (reviews/2026-07-26/feedback-0002/feedback.md)
