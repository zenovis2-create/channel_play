...
Task ID: task-0008
Status: planned
Suggested agent: critic_reviewer
Suggested reviewer: none
Required evidence: findings-first review linked to implementation evidence

## Request

피드백 수정 리스크 리뷰: Reframe `Operator_Overview_Camera` to show the playable School MVP route, player start, and primary objective landmarks in one legible overview. Keep the capture deterministic and retain the non-blank PNG validation. (reviews/2026-07-26/feedback-0002/feedback.md)
