...
Goal: Use existing verified task receipts as Agent Progress Visibility evidence when no Studio job ledger entries exist
Read first: agents/company.md, agents/memory_policy.md, memory/company/current_brief.md, memory/company/task-0017-plan.md
Allowed write paths:
...
Inputs: memory/company/task-0017-plan.md, task request, and current brief
Expected output: changed files or report matching role contract
Verification required: verified-task visibility regression tests, runtime status receipt, full Python suite, and critic review
