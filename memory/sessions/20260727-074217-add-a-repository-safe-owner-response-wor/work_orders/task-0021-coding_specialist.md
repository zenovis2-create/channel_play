...
Read first: agents/company.md, agents/memory_policy.md, memory/company/current_brief.md, memory/company/task-0021-plan.md
Allowed write paths:
...
Inputs: memory/company/task-0021-plan.md, task request, and current brief
Expected output: changed files or report matching role contract
Verification required: worksheet safety tests, partial/complete/indeterminate state tests, Studio UI contract tests, JavaScript syntax check, runtime receipt, full Python suite, and critic review
